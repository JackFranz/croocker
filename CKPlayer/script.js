...
const video_player = document.querySelector("#video_player"),
  ...
  controls = video_player.querySelector('.rodiki'),
  ...
  play_play = video_player.querySelector(".play_play"),
  fast_forward = video_player.querySelector(".fast-forward"),
  volume = video_player.querySelector(".volume"),
  lock = video_player.querySelector("#lock"),
  unlock = video_player.querySelector("#unlock"),
...
function updatePlayButton() {
	...
	if (video_player.paused) {
		play_pause.innerHTML = `<img class="icon" width="24px" src="./icons/play.png"/>
   `;  
	  } else {
		play_pause.innerHTML = `<img class="icon" width="24px" src="./icons/pause.png"/>
   `;
	  }
