...
function canPlayInit() {
  ...
  if (video.paused) {
    ...
    handleMainStateIcon(`<img src="./icons/play.png" id="icon-rodiki">`);
  }
}
...
function play() {
  video.play();
  isPlaying = true;
  playPause.innerHTML = `<img src="./icons/pause.png" id="icon-rodiki">`;
  mainState.classList.remove("show-state");
  handleMainStateIcon(`<img src="./icons/pause.png" id="icon-rodiki">`);
  // watchProgress();
}
...
function pause() {
  video.pause();
  isPlaying = false;
  playPause.innerHTML = `<img src="./icons/play.png" id="icon-rodiki">`;
  controls.classList.add("show-controls");
  mainState.classList.add("show-state");
  handleMainStateIcon(`<img src="./icons/play.png" id="icon-rodiki">`);
  if (video.ended) {
...
function toggleMuteUnmute() {
  if (!muted) {
    video.volume = 0;
    muted = true;
    muteUnmute.innerHTML = `<img src="./icons/off-volumen.png" id="icon-rodiki" class="ico-vol">`;
    handleMainStateIcon(`<img src="./icons/off-volumen.png" id="icon-rodiki" class="ico-vol">`);
    totalVol.classList.remove("show");
  } else {
    video.volume = volumeVal;
    muted = false;
    totalVol.classList.add("show");
    handleMainStateIcon(`<img src="./icons/volume.png" id="icon-rodiki" class="ico-vol">`);
    muteUnmute.innerHTML = `<img src="./icons/volume.png" id="icon-rodiki" class="ico-vol">`;
  }
}
...
function toggleFullscreen() {
  if (!document.fullscreenElement) {
    ...
    handleMainStateIcon(`<img src="./icons/in-fullscreen.svg" id="icon-rodiki">`);
...
function handleMainSateAnimationEnd() {
  ...
  if (!isPlaying) {
    mainState.innerHTML = `<img src="./icons/play.png" id="icon-rodiki"/>`;
  }
